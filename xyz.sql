...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2025 at 01:17 PM
...
(10229, '2004-03-11', '2004-03-20', '2004-03-12', 'Shipped', 124, 'S32_3522', 30, 5230),
...
--
-- Constraints for table `orders_1`
--
ALTER TABLE `orders_1`
  ADD CONSTRAINT `customerID` FOREIGN KEY (`customerID`) REFERENCES `customer` (`customerID`);

--
-- Constraints for table `orders_2`
--
ALTER TABLE `orders_2`
  ADD CONSTRAINT `CustomerID2` FOREIGN KEY (`customerID`) REFERENCES `customer` (`customerID`);
COMMIT;
